...
$(function() {
	...
	// 根据类别或者搜索关键词与页面索引、页面大小获取博客列表
	// 这个方法设计的不够好，不够通用，需要改进 TODO
	...
	/*获取喜欢的文章*/
	$("#getLikedBlogs").click(function () {
		$.ajax({
			url: "/space/"+  username  +"/likedBlogs",
			type: 'get',
			beforeSend: function(request) {
				//request.setRequestHeader(csrfHeader, csrfToken); // 添加  CSRF Token
			},
	...
	// 根据标签查询
	$(".blog-content-container").on("click",".blog-query-by-tag", function () {
